...
!           '3' glassosub
!           '4' cglasso_v2
subroutine cggm_v2(n,q,X,p,Y,Id,nP,InfoP,lo,up,ym,yv,wB,pendiag,wTht,ntp,lambda,rho,maxit_em,thr_em,maxit_bcd,thr_bcd,&
...
! code_conv
        ...
        if(trace.eq.2) call trace_cglasso_v2_2_7(thr_em, dB, dSgm, (dB + dSgm) / count)
